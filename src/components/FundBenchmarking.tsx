...
const FundBenchmarking = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 md:space-y-12 pb-10 md:pb-20 font-sans bg-white text-left">
      ...
      <div className="mb-6">
        <span className="text-[10px] font-bold text-emerald-600 uppercase tracking-widest">● Live Fund Data — 21,000+ Funds</span>
      </div>  
...
{managerFunds.length > 1 && (
      ...
      <div className="border-t border-[#E2E8F0] pt-6 mt-4">
        <p className="text-[10px] text-[#94A3B8] leading-relaxed">
          Disclaimer: This tool is for informational purposes only. Fund universe and performance data sourced from a licensed institutional data provider, Q2 2026. Benchmark quartile thresholds are illustrative and based on published industry averages.
        </p>
      </div>
    </div>
  );
