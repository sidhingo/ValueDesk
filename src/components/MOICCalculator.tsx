    ...
    <div className="max-w-6xl mx-auto space-y-8 md:space-y-12 pb-10 md:pb-20 font-sans bg-white text-left">
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-stretch">
        <div className="w-full lg:w-2/3 bg-white p-6 md:p-8 border border-[#E2E8F0] shadow-sm">
          <div className="space-y-8 md:space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
              <div className="space-y-6">
                <h3 className={headerStyle}>Time Horizon (Years)</h3>
              ...
              <div className="space-y-6">
                <h3 className={headerStyle}>Interim Flows ($M)</h3>
        ...
        {/* RESULTS PANEL */}
        <div className="w-full lg:w-1/3 bg-[#F8FAFC] border border-[#E2E8F0] p-6 md:p-10 flex flex-col justify-center shadow-inner min-h-[350px] md:min-h-[480px]">
          {!result ? (
              ...
              <div className="space-y-6 md:space-y-8">
                <div className="border-b border-[#E2E8F0] pb-6 flex justify-between items-end">
                  ...
                  <div className="text-right">
                    <span className="text-[10px] font-bold text-[#64748B] block mb-1">MOIC</span>
                    <span className="text-xl md:text-2xl font-normal text-[#1E293B]">{result.moic}x</span>
                  </div>
                </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 border-t border-[#E2E8F0] pt-12">
        <div className="space-y-8">
          ...
          <div className="space-y-6">
            <p className="text-[13px] text-[#64748B] leading-[1.7]">The tool calculates the <strong>Total Basis</strong> and <strong>Net Proceeds</strong>. The relationship between these values over time determines the annualized return profile.</p>
            <div className="bg-[#F8FAFC] p-6 md:p-8 border border-[#E2E8F0] flex flex-col space-y-4 overflow-x-auto">
              <div className="flex flex-col items-center border-b border-[#E2E8F0] pb-4 min-w-[250px]">
                <span className="text-[9px] font-bold text-[#94A3B8] uppercase mb-2">Step 1: Multiple on Capital</span>
                <div className="text-[12px] md:text-[14px] text-[#1E293B] font-mono text-center italic">MOIC = (Net Exit Value + Dividends) / (Equity Investment + Fees)</div>
              </div>
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-6 md:space-y-8">
            <div className="border-l border-[#1E293B] pl-5">
              <strong className="text-[12px] uppercase block mb-2 font-black">Transaction Friction</strong>
              <p className="text-[13px] text-[#64748B]">Fees at entry and exit can significantly compress MOIC, creating a performance drag on the net basis.</p>
            </div>
            <div className="border-l border-[#1E293B] pl-5">
              <strong className="text-[12px] uppercase block mb-2 font-black">Dividend Recaps</strong>
              <p className="text-[13px] text-[#64748B]">Early distributions disproportionately boost IRR because they reduce the "at-risk" hold period for that portion of capital.</p>
            </div>
          </div>
        </div>
      </div>
